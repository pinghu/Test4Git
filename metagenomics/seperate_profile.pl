...
system("mkdir ./average_genome_length_in_the_clade\n");
...
while (my $a=<A>){
    ...
    open (E, ">./average_genome_length_in_the_clade/$a")||die "could not open ./average_genome_length_in_the_clade/$a\n";
    open(F, ">./estimated_number_of_reads_from_the_clade/$a")||die "could not open ./estimated_number_of_reads_from_the_clade/$a\n" ;
    my $nn=<B>;
    print E $nn;
    print C $nn; 
    print D $nn; 
